...
To deGoogle means to stop using anything that belongs to Google, anything that was made by Google. I'm talking about their search engine, their mail service (Gmail), Youtube, etc.


## Why deGoogle?

Google is one of the most powerful companies in the world right now. They have stored a huge amount of information on all of us. Some would argue that our information is safe and they know how to protect it, but this isn't true. Google has been hacked before and it will be hacked in the future. There is also the possibility that some employee with access to your information would sell your data or a bug that causes a data leak. Google stores personal information on all of us because this is how they make money.

They scan our emails, store what we search when we're using their search engine, what videos we watch on Youtube. If you think this is creepy  you should start deGoogling right now. Don't know where to start? don't worry. Here we offer alternatives for services Google offers so you can continue your activity without relying on Google.
...
**Google reCAPTCHA**
   ...
   * [Sweet Captcha](https://www.sweetcaptcha.com/)
   * [Confident Captcha](https://confidenttechnologies.com/confident-captcha/)
   * [UniqPin](http://uniqpin.com/)
   * [MTCaptcha](https://www.mtcaptcha.com/)
   * [Captcheck](https://source.netsyms.com/Netsyms/Captcheck)
